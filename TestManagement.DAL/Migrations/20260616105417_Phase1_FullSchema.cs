...
{
    /// <inheritdoc />
    public partial class Phase1_FullSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropIndex(
                name: "IX_Questions_SubjectId_Difficulty_Status_IsDeleted",
                table: "Questions");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionItemsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PublishedSnapshotJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnswerKeyJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionAuditLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionAuditLogs_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionAuditLogs_Users_ActionBy",
                        column: x => x.ActionBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamAssignments_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    QuestionSnapshotJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AttemptMetaJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamAuditLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamAuditLogs_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamAuditLogs_Users_ActionBy",
                        column: x => x.ActionBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedDisplayLabel = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    AnswerJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnswerHistoryJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAssignments_ExamId_ClassId",
                table: "ExamAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAuditLogs_ActionBy",
                table: "ExamAuditLogs",
                column: "ActionBy");

            migrationBuilder.CreateIndex(
                name: "IX_ExamAuditLogs_ExamId",
                table: "ExamAuditLogs",
                column: "ExamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_SubjectId_Status_IsDeleted",
                table: "Exams",
                columns: new[] { "SubjectId", "Status", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionAuditLogs_ActionBy",
                table: "QuestionAuditLogs",
                column: "ActionBy");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionAuditLogs_QuestionId",
                table: "QuestionAuditLogs",
                column: "QuestionId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_SubjectId_Difficulty_Status_IsDeleted",
                table: "Questions",
                columns: new[] { "SubjectId", "Difficulty", "Status", "IsDeleted" });
        }
    }
}
