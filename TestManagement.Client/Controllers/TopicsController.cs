...
public class TopicsController : Controller
{
    ...
    // UC17 - View Topic List & UC30 (hỗ trợ filter)
    public async Task<IActionResult> Index(string? keyword, int? subjectId, string? status, int page = 1, int pageSize = 10)
    {
        ...
        // Lấy danh sách Môn học để hiển thị Dropdown Filter và Dropdown trong Modal Thêm/Sửa
        ViewBag.Subjects = await _subjectService.GetSubjectOptionsAsync();
