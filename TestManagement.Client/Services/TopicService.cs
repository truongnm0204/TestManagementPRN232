...
using TestManagement.Client.Models.Topics; // Bạn đảm bảo đã tạo thư mục Models/Topics chứa các ViewModel tương ứng
...
public class TopicService
{
    ...
    public Task<ApiResult<ODataListResult<TopicItemViewModel>>> GetListAsync(string? keyword, int? subjectId, string? status, int page, int pageSize)
    {
        ...
        var endpoint = ODataQueryBuilder.Build("api/topics", ODataQueryBuilder.And(filters.ToArray()), "DisplayOrder", page, pageSize);
